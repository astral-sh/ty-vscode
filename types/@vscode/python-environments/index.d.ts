// Copied from https://github.com/microsoft/vscode-python-environments/blob/main/pythonEnvironmentsApi/src/main.ts
// We should use the NPM package once https://github.com/microsoft/vscode-python-environments/issues/967 is resolved.
...
export interface PythonProjectApi
  extends PythonProjectCreationApi, PythonProjectGetterApi, PythonProjectModifyApi {}
...
export namespace PythonEnvironments {
   ...
   */
  export function api(): Promise<PythonEnvironmentApi> {
