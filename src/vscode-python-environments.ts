/**
 * This file is copied from https://github.com/microsoft/vscode-python-environments/blob/main/src/api.ts 
 * because Microsoft doesn't publish the API as a separate package...
 * 
 * 
 */
